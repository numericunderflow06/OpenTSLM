#!/usr/bin/env python3
"""
Test ALL COMPLETE encoders - all 4 should work now!
"""
...
print("="*80)
print("COMPLETE TEST - ALL 4 ENCODERS WITH REAL PRETRAINED MODELS")
print("="*80)
    ...
    try:
        ...
        for i, (batch_size, seq_len, n_features) in enumerate(test_cases, 1):
            ...
            if output.shape != expected_shape:
                ...
                all_passed = False
            elif output.device.type != DEVICE:
                print(f"  ✗ Device mismatch! Expected {DEVICE}")
                all_passed = False
            else:
                print(f"  ✓ Test passed")
...
def main():
    ...
    # Test 1: Chronos Complete
    print("\n" + "="*80)
    print("1. CHRONOS COMPLETE ENCODER (FIXED)")
    print("="*80)
    ...
    try:
        ...
        success, error = test_encoder(
            ...
            test_cases=[(2, 100, 1), (3, 512, 1), (4, 256, 1)]
        )
    ...
    # Test 2: PatchTST Complete
    print("\n" + "="*80)
    print("2. PATCHTST COMPLETE ENCODER (FIXED)")
    print("="*80)
    ...
    try:
        ...
        success, error = test_encoder(
            ...
            test_cases=[(2, 512, 7), (3, 384, 5), (4, 256, 1)]  # Various channel counts
        )
    ...
    # Test 3: TimesFM (already working)
    print("\n" + "="*80)
    print("3. TIMESFM ENCODER (ALREADY WORKING)")
    print("="*80)
    ...
    try:
        ...
        success, error = test_encoder(
            ...
            test_cases=[(2, 512, 1), (3, 256, 1), (4, 384, 1)]
        )
    ...
    for encoder_name, (success, error) in results.items():
        if success:
            print(f"✅ {encoder_name:15s} - WORKING PERFECTLY")
            passed_count += 1
        else:
    ...
    if passed_count == len(results):
        print("\n🎉 COMPLETE SUCCESS! ALL 4 ENCODERS WORKING!")
        print("\nAll encoders are using:")
        ...
        print("  • ChronosCompleteEncoder - Chronos with proper device handling")
        print("  • PatchTSTCompleteEncoder - PatchTST with fixed dimensions")
        print("  • TimesFMFinalEncoder - TimesFM fully working")
        print("  • MOMENTEncoderReal - MOMENT reference implementation")
    else:
        print(f"\n⚠️  {passed_count} encoder(s) working, {len(results)-passed_count} still have issues")
