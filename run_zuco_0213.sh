#!/bin/bash
# Sequential ZuCo experiments on GPU 1 — 2026-02-13
set -e
...
echo "=========================================="
echo "  Experiment 1/3: Sleep → ZuCo 1.0"
echo "=========================================="
python curriculum_learning.py \
    ...
    2>&1 | tee "$LOGDIR/zuco1_sleep.log"

echo ""
echo "=========================================="
echo "  Experiment 2/3: From scratch → ZuCo 1.0"
echo "=========================================="
python curriculum_learning.py \
    --model $MODEL \
    --llm_id "$LLM_ID" \
...
echo ""
echo "=========================================="
echo "  Experiment 3/3: From scratch → ZuCo 2.0"
echo "=========================================="
python curriculum_learning.py \
    --model $MODEL \
    --llm_id "$LLM_ID" \
