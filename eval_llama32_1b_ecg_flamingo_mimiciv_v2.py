...
def evaluate_model_on_mimiciv_mini100():
    ...
    try:
        # Initialize Flamingo model
        print("Initializing Flamingo model...")
    ...
    with torch.no_grad():
        for batch_idx, batch in enumerate(tqdm(dataloader, desc="Evaluating")):
            ...
            if (batch_idx + 1) % 10 == 0:
                ...
                print(f"Last prediction: {prediction[:100]}...")
    ...
    with open(summary_file, 'w') as f:
        ...
        f.write(f"Architecture: OpenTSLMFlamingo\n")
