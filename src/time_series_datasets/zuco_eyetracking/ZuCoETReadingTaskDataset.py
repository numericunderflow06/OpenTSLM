#
# ZuCo Eye-Tracking Reading Task Classification Dataset for OpenTSLM
#
...
from time_series_datasets.zuco_eyetracking.zuco_et_loader import (
    load_zuco_et_reading_task_splits,
    ET_METRICS,
    ET_METRIC_LABELS,
)
import torch
...
class ZuCoETReadingTaskDataset(QADataset):
    def __init__(
        self,
    ...
    def _load_splits(self) -> Tuple[Dataset, Dataset, Dataset]:
        return load_zuco_et_reading_task_splits()
...
if __name__ == "__main__":
    print("=== ZuCo Eye-Tracking Reading Task Dataset ===\n")

    dataset = ZuCoETReadingTaskDataset(split="train", EOS_TOKEN="")
    dataset_val = ZuCoETReadingTaskDataset(split="validation", EOS_TOKEN="")
    dataset_test = ZuCoETReadingTaskDataset(split="test", EOS_TOKEN="")
